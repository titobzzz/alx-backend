#!/usr/bin/env python3
"""
Contains-class with methodscreate simple paginationcsv data
"""
import csv
...
class Server:
    """Server class topaginate adatabase of popularbaby names.
    """
    ...
    def dataset(self) -> List[List]:
        """
        Readsfrom csv fileand returns the dataset.
    ...
    def assert_positive_integer_type(value: int) -> None:
        ...
        Args:value (int): The value to be asserted.
        """
